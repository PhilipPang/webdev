         ...
         <div id="myappt">
            <div class="row">
               <div class="col-1">
                                          ...
                                          <ul class="nav navbar-nav">
                                             <li class="nav-item dropdown-hover dropdown">
                                                <a href="#" class="dropdown-toggle" data-bs-placement="top-start"
                                                   data-bs-toggle="dropdown"><i class="fa fa-times-circle"></i>Cancel<b
                                                      class="caret"></b></a>
                  ...
                  $sql = "SELECT booking.*, technicians.* FROM (booking INNER join technicians ON booking.tech_ID = technicians.tech_ID) WHERE booking.user_ID = '$user_id' AND booking.booking_status = 'Cancel' AND booking.user_cancel_note = '0' ORDER BY booking.booking_ID DESC;";
                                    ...
                                    <div id="btn-row">
                                       <div class="row">
                                          ...
                                          <form action="php/delete-booking.php" method="post">
                                             <button type="submit" id="btn-dr" name="delete-appt" value="' . $booking_ID  . '" 
                                             class="ui-button ui-corner-all"><span class="ui-button-icon ui-icon ui-primary"></span>
                                             <span class="ui-button-icon-space"> 
                                             </span>Delete Record</button>
                                             </form>
                                          </div>
                                          <div class="col-2">
                                          </div>
