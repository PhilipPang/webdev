...
<body>
   ...
   <div class="col-2">
      ...
      $sql = "SELECT * FROM booking  WHERE user_ID = '$user_id' AND booking_ID = '$booking_ID' ";
    ...
    echo "<script> alert('Unable to Find data');</script>";
      ...
      <div id="user_appt-layout">
         <form name="Edit Info" method="post" action="php/update-booking-p.php" id="appt-layout">
            <div class="row">
               <div class="col-1">
                        ...
                        <div class="row">
                           <div class="col-1">
                              ...
                              <div id="user_data-first-name">
                                 <p><span class="p-dark">Null</span></p>
                              </div>
                           </div>
                           <div class="col-2">
