      ...
      <div id="LayoutGrid1">
         <div class="row">
            <div class="col-1">
               <div id="user_LayoutGrid2">
                  <div id="LayoutGrid2">
                     <div class="row">
                        <div class="col-1">
                           <div id="user_Text1">
                              <h2>Your Booking was posted successful</h2><br/>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div id="user_Text2">
                  <h6>Please wait for technician to accept your appointment request. Thankyou</h6><br/><h6>Click </h6><a href="./pending.php"><h6>here</h6></a><h6> to view appointment status</h6><br/>
               </div>
            </div>
         </div>
      </div>
