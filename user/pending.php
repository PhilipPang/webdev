         ...
         <div id="myappt">
            <div class="row">
               <div class="col-1">
                                             ...
                                             <li class="nav-item dropdown-hover dropdown">
                                                <a href="#" class="dropdown-toggle" data-bs-placement="top-start"
                                                   data-bs-toggle="dropdown"><i
                                                      class="fa fa-question-circle"></i>Pending<b class="caret"></b></a>
                  ...
                  $sql = "SELECT * FROM booking WHERE user_ID = '$user_id' AND booking_status = 'Pending' ORDER BY booking_ID DESC;";
                     ...
                     while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <div class="row">
                           ...
                           <div class="col-2">
                              ...
                              <div id="user_-appt-ser_id" class="h4">
                                 <h4>' . $services_name   . '</h4>
                              </div>
                              ...
                              <div id="user_btn-row">
                                 <div id="btn-row">
                                    <div class="row">
                                       <div class="col-1">
                                       <form action="edit-info-p.php" method="post">
                                       ...
                                       <div class="col-2">
                                       <form action="php/cancel-booking-p.php" method="post">
