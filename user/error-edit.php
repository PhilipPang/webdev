      ...
      <div id="LayoutGrid1">
         <div class="row">
            <div class="col-1">
               ...
               <div id="user_Text2">
                  <h6>Make sure your booking date time is 24hour after your current date time</h6><br/><h6>Click </h6><a href="./my-appointment.php"><h6>here</h6></a><h6> to </h6><h6>re-submit your appointment again</h6><br/>
               </div>
            </div>
         </div>
      </div>
