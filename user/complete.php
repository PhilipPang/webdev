         ...
         <div id="myappt">
            <div class="row">
               <div class="col-1">
                                             ...
                                             <li class="nav-item dropdown-hover dropdown">
                                                <a href="#" class="dropdown-toggle" data-bs-placement="top-start"
                                                   data-bs-toggle="dropdown"><i
                                                      class="fa fa-check-circle"></i>Complete<b class="caret"></b></a>
                  ...
                  $sql = "SELECT booking.*, technicians.* FROM (booking INNER join technicians ON booking.tech_ID = technicians.tech_ID) WHERE booking.user_ID = '$user_id' AND booking.booking_status = 'Complete' ORDER BY booking.booking_ID DESC;";
