...
<head>
   ...
   <link href="css/change-date.css" rel="stylesheet">
         ...
         <div id="myappt">
            <div class="row">
               <div class="col-1">
                                       ...
                                       <div class="myappt-menu-navbar-collapse collapse">
                                          <ul class="nav navbar-nav">
                                             <li class="nav-item dropdown-hover dropdown">
                                                <a href="#" class="dropdown-toggle active" data-bs-placement="top-start"
                                                   data-bs-toggle="dropdown"><i class="fa fa-circle"></i>Change Date<b
                                                      class="caret"></b></a>
                                                <ul class="dropdown-menu">
                                                   <li class="nav-item dropdown-item">
                                                      <a href="./my-appointment.php" class="nav-link"><i
                                                            class="fa fa-exclamation-circle"></i>Comming Soon</a>
                                                   </li>
                                                   <li class="nav-item dropdown-item">
                  ...
                  $sql = "SELECT booking.*, technicians.* FROM (booking INNER join technicians ON booking.tech_ID = technicians.tech_ID) WHERE booking.user_ID = '$user_id' AND booking.booking_status = 'Changing' ORDER BY booking.booking_ID DESC;";
                                 ...
                                 <div id="btn-row">
                                    <div class="row">
                                       ...
                                       <form action="edit-info.php" method="post">
                                          <button type="submit" id="btn-ei" name="edit_info" value="' . $booking_ID  . '"
                                             class="ui-button ui-corner-all"><span
                                                class="ui-button-icon ui-icon ui-primary"></span><span
                                                class="ui-button-icon-space"> </span>Edit Info</button>
                                          </form>
                                       </div>
                                       <div class="col-2">
                                       <form action="php/cancel-booking.php" method="post">
                                          <button type="submit" id="btn-ca" name="cance-appt" value="' . $booking_ID  . '"
                                             class="ui-button ui-corner-all"><span
                                                class="ui-button-icon ui-icon ui-primary"></span><span
                                                class="ui-button-icon-space"> </span>Cancel Appointment</button>
                                          </form>
                                       </div>
                                       <div class="col-3">
                                       </div>
