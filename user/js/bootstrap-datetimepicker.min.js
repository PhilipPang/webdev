//https://codepen.io/kanan-mahudhia/pen/eWexzP
+(function (a) {
    function e() {
    ...
    a.fn.emulateTransitionEnd = function (d) {
        var b = !1,
            c = this;
        a(this).one("dtTransitionEnd", function () {
            b = !0;
        });
        setTimeout(function () {
    ...
    a(function () {
        ...
        a.support.transition &&
            (a.event.special.dtTransitionEnd = {
...
+(function (c) {
    function h(a) {
        var b;
        a = a.attr("data-target") || ((b = a.attr("href")) && b.replace(/.*(?=#[^\s]+$)/, ""));
        return c(a);
    }
    function g(a) {
        return this.each(function () {
            var b = c(this),
                f = b.data("dt.collapsedatetime"),
                e = c.extend({}, d.DEFAULTS, b.data(), "object" == typeof a && a);
            !f && e.toggle && /show|hide/.test(a) && (e.toggle = !1);
            f || b.data("dt.collapsedatetime", (f = new d(this, e)));
    ...
    var d = function (a, b) {
        ...
        this.$trigger = c('[data-toggle="collapsedatetime"][href="#' + a.id + '"],[data-toggle="collapsedatetime"][data-target="#' + a.id + '"]');
    ...
    d.prototype.show = function () {
        if (!this.transitioning && !this.$element.hasClass("in")) {
            var a,
                b = this.$parent && this.$parent.children(".panel").children(".in, .collapsingdatetime");
            if (b && b.length && (a = b.data("dt.collapsedatetime")) && a.transitioning) return;
            var f = c.Event("show.dt.collapsedatetime");
            this.$element.trigger(f);
            if (!f.isDefaultPrevented()) {
                b && b.length && (g.call(b, "hide"), a || b.data("dt.collapsedatetime", null));
                var e = this.dimension();
                this.$element.removeClass("collapsedatetime").addClass("collapsingdatetime")[e](0).attr("aria-expanded", !0);
                this.$trigger.removeClass("collapseddatetime").attr("aria-expanded", !0);
                this.transitioning = 1;
                a = function () {
                    this.$element.removeClass("collapsingdatetime").addClass("collapsedatetime in")[e]("");
                    this.transitioning = 0;
                    this.$element.trigger("shown.dt.collapsedatetime");
                };
                if (!c.support.transition) return a.call(this);
                b = c.camelCase(["scroll", e].join("-"));
                this.$element.one("dtTransitionEnd", c.proxy(a, this)).emulateTransitionEnd(d.TRANSITION_DURATION)[e](this.$element[0][b]);
            }
        }
    };
    d.prototype.hide = function () {
        if (!this.transitioning && this.$element.hasClass("in")) {
            var a = c.Event("hide.dt.collapsedatetime");
            this.$element.trigger(a);
            if (!a.isDefaultPrevented()) {
                a = this.dimension();
                this.$element[a](this.$element[a]())[0].offsetHeight;
                this.$element.addClass("collapsingdatetime").removeClass("collapsedatetime in").attr("aria-expanded", !1);
                this.$trigger.addClass("collapseddatetime").attr("aria-expanded", !1);
                this.transitioning = 1;
                var b = function () {
                    this.transitioning = 0;
                    this.$element.removeClass("collapsingdatetime").addClass("collapsedatetime").trigger("hidden.dt.collapsedatetime");
                };
                if (!c.support.transition) return b.call(this);
                this.$element[a](0).one("dtTransitionEnd", c.proxy(b, this)).emulateTransitionEnd(d.TRANSITION_DURATION);
            }
        }
    };
    ...
    d.prototype.getParent = function () {
        return c(this.options.parent)
            .find('[data-toggle="collapsedatetime"][data-parent="' + this.options.parent + '"]')
            .each(
    ...
    d.prototype.addAriaAndCollapsedClass = function (a, b) {
        ...
        b.toggleClass("collapseddatetime", !c).attr("aria-expanded", c);
    };
    var k = c.fn.collapsedatetime;
    c.fn.collapsedatetime = g;
    c.fn.collapsedatetime.Constructor = d;
    c.fn.collapsedatetime.noConflict = function () {
        c.fn.collapsedatetime = k;
        return this;
    };
    c(document).on("click.dt.collapsedatetime.data-api", '[data-toggle="collapsedatetime"]', function (a) {
        var b = c(this);
        b.attr("data-target") || a.preventDefault();
        a = h(b);
        b = a.data("dt.collapsedatetime") ? "toggle" : b.data();
        g.call(a, b);
    });
})(jQuery);
!(function (a) {
    ...
    var c = function (c, d) {
        var e,
            ...
            G = function () {
                var b = a("<div>").addClass("bootstrap-datetimepicker-widget dropdown-menu"),
                    ...
                    g = a("<li>")
                        .addClass("picker-switch" + (d.collapsedatetime ? " accordion-toggle" : ""))
                        .append(F());
                return (
                    ...
                    d.sideBySide && B() && A()
                        ...
                        : ("top" === d.toolbarPlacement && f.append(g),
                          B() &&
                              f.append(
                                  a("<li>")
                                      .addClass(d.collapsedatetime && A() ? "collapsedatetime in" : "")
                                      .append(c)
                              ),
                          ...
                          A() &&
                              f.append(
                                  a("<li>")
                                      .addClass(d.collapsedatetime && B() ? "collapsedatetime" : "")
                                      .append(e)
                              ),
            ...
            ba = function () {
                var b = !1;
                return o
                    ? (o.find(".collapsedatetime").each(function () {
                          var c = a(this).data("collapsedatetime");
            ...
            ea = {
                ...
                togglePicker: function (b) {
                    var c,
                        ...
                        f = e.closest("ul"),
                        g = f.find(".in"),
                        h = f.find(".collapsedatetime:not(.in)");
                    if (g && g.length) {
                        if (((c = g.data("collapsedatetime")), c && c.transitioning)) return;
                        g.collapsedatetime ? (g.collapsedatetime("hide"), h.collapsedatetime("show")) : (g.removeClass("in"), h.addClass("in")),
        ...
        if (
            ...
            (l.collapsedatetime = function (a) {
                if (0 === arguments.length) return d.collapsedatetime;
                if ("boolean" != typeof a) throw new TypeError("collapsedatetime() expects a boolean parameter");
                return d.collapsedatetime === a ? l : ((d.collapsedatetime = a), o && (ba(), ga()), l);
            }),
            (l.icons = function (b) {
