    ...
    try{
        include("conn.php");
            ...
            if (mysqli_query($con, $sql)) {
                echo "<script> alert('Record Updated!'); window.location.href='admin_profile.php';</script>";
            }
            else{
                echo "<script> alert('Record failed to Update!'); window.location.href='admin_profile.php';</script>";
                }
