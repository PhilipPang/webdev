...
<head>
    ...
    <title>Profile</title>
    <link rel="stylesheet" href="admin_admin_edit.css">
</head>
<body>
    <?php
    ...
    <form action="admin_admin_update.php" method="POST" enctype="multipart/form-data">
    <div class="profile">
        <input type="hidden" name="admin_ID" value="<?php echo $row['admin_ID'] ?>">

        <div id="profileimage"><img id="adimage" src="data:image;base64,<?php echo $row['admin_profilepic']?>"><input type="file" id="img" name="admin_profilepic" style="display:none;"/>
        ...
        <div id="informationbackground">
            ...
            <span id="first">First Name:<br><br>
                <input type="text" placeholder="First Name" class="inputbox" name="admin_firstname" value="<?php echo $row["admin_firstname"] ?>" required pattern="[^\d]+" title="Digits are not allowed!">
            </span>

            <span id="last">Last Name: <br><br>
                <input type="text" placeholder="Last Name" class="inputbox" name="admin_lastname" value="<?php echo $row["admin_lastname"] ?>" required pattern="[^\d]+" title="Digits are not allowed!">
            </span>
            ...
            <span id="ic">IC Number: <br><br>
                <input type="text" placeholder="IC Number" name="admin_ic" class="inputbox" value="<?php echo $row["admin_ic"]?>" required pattern="[0-9]+" title="Only Integers are Accepted!">
            </span>

            <span id="bday">Birth Date:<br><br>
                <input type="date" placeholder="Birthday" name="admin_birthdate" class="inputbox" value="<?php echo $row["admin_birthdate"]?>" required>
            </span>

            <span id="mobilenum">Mobile Number: <br><br>
                <input type="tel" placeholder="Mobile Number" name="admin_mobilenum" class="inputbox" value="<?php echo $row["admin_mobilenum"]?>" required pattern="[0-9]+" title="Only Integers are Accepted!">
            </span>

            <span id="address">Address: <br><br>
                <textarea placeholder="Address:" class="textarea" name="admin_address" required><?php echo $row["admin_address"]?></textarea>
            </span>
        ...
        <div id="logincredentials">
            ...
            <span id="loginemail">Email: <br><br>
                <input type="email" placeholder="Email Address" name="admin_email" class="inputbox3" value="<?php echo $row["admin_email"]?>" required>
            </span>

            <span id="loginpassword">Password: <br><br>
                <input type="password" placeholder="Password" name="admin_password" minlength="6" title="Minimum 6 characters or digits!" class="inputbox3" id="passwordview" value="<?php echo $row["admin_password"]?>"><i class='bx bx-show' id="showpassword" onclick=password()></i>
            </span>
