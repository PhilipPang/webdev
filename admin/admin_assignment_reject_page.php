...
<head>
    ...
    <link rel="stylesheet" href="admin_assignment_reject_page.css">
...
<body>
        ...
        while ($row = mysqli_fetch_array($result)){
            ...
            echo '
                <div id="assignmentbox">
                    ...
                    <div id="assignmentfile">hello.pdf</div>
                    <div id="assignmentfile2">hello.pdf</div>
    ...
    <form action="admin_assignment_reject.php" method="POST">
        <div id="formbackground">
            <a href="admin_assignment.php"><span id="closeprogram"><i class='bx bx-x'></i></span></a>

            <input type="hidden" name="project_ID" value=<?php echo $id ?>>

            <span id="projectid">Project ID: <?php echo $id ?></span>

            <span id="rejecttitle">Reject Reason:</span>
            <textarea name="reject_reason" id="rejectreason" required></textarea>

            <input type="radio" id="rejection" value = 2 name="assignment_status" checked>
            <label for="rejection" id="rejection2">Reject</label>

            <button type="submit" id="savereject">Save Changes</button>
        </div>
    </form>

    <a href="admin_assignment.php"><div class="rejectbackground"></div></a>
    ...
    <script>
        ...
        document.getElementById("nav_ass").className = "active"; 
    </script>
</body>
</html>