...
try{
    ...
    VALUES ('$mysupervisor','Rejection!', 'Your assignment has been rejected!', '$date' , 0)";


    if (mysqli_query($con, $sql) && mysqli_query($con, $sql2)) {
        echo "<script> alert('Rejected Assignment!'); window.location.href='admin_assignment.php';</script>";
    }
    else{
